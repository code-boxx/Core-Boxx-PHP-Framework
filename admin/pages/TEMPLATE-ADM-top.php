...
<html>
  <head>
    ...
    <title><?=isset($_PMETA["title"])?$_PMETA["title"]:"Core Boxx Admin"?></title>
    <meta charset="utf-8">
    ...
    <meta name="apple-mobile-web-app-title" content="Core Boxx Admin">
      ...
      <nav id="cb-side" class="bg-dark text-white p-2"><ul class="navbar-nav">
        <li class="nav-item">
          ...
          <a class="nav-link ms-2" href="<?=HOST_ADMIN?>">
            <span class="mi mi-smol">campaign</span> Link
          </a>
          <a class="nav-link ms-2" href="<?=HOST_ADMIN?>">
            <span class="mi mi-smol">category</span> Link
          </a>
          <hr>
        </li>
        <li class="nav-item">
