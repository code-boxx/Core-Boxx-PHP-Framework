...
<div class="bg-light border p-3 mb-3"><?php print_r($_CORE); ?></div>
...
<div class="bg-light border p-3 mb-3"><?php echo $_PATH; ?></div>

<!-- (C) SESSION -->
<div class="bg-primary text-white p-3">
  <strong>$_SESS</strong> - Something like the default PHP <strong>$_SESSION</strong>.
</div>
<div class="bg-light border p-3 mb-3"><?php print_r($_SESS); ?></div>

<!-- (D) PAGE -->
<div class="bg-primary text-white p-3">
  <strong>$_PAGE</strong> - Current physical file.
</div>
<div class="bg-light border p-3 mb-3"><?=$_PAGE?></div>
